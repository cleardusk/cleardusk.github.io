...
github_repo: cleardusk/3DDFA_V2
# arxiv: https://arxiv.org/abs/1901.00488
---
We propose a novel regression framework, named <b>3DDFA_V2</b>, to make a balance among speed, accuracy and stability.
Our model runs at over 50fps on a single CPU core (>200fps with ONNX acceleration) and outperforms other state-of-the-art heavy models simultaneously. Code and models are available at <a href="https://github.com/cleardusk/3DDFA_V2" target="_blank" rel="noopener noreferrer"><strong>https://github.com/cleardusk/3DDFA_V2</strong></a>.
