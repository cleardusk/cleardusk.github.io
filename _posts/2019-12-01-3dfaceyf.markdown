...
---
This paper constructs a new dataset Fine-Grained 3D face (FG3D) with 200k samples for training, and proposes a Fine-Grained reconstruction Network (FGNet) concentrating on shape modication by warping the network input and output to the UV space. FG3D is available at <a href="https://github.com/XiangyuZhu-open/Beyond3DMM">https://github.com/XiangyuZhu-open/Beyond3DMM</a>.
